...
/**
 * Assessment of SAMJ. Test the effect of noise levels.
 * 
 * @author Daniel Sage
 *
 */

public class SAMJ_BenchmarkNoise implements PlugIn {
	
	private String nameExperiment = "Structural-Noise";
	private int nIterations = 1;
	private int nModels = 6; // Number of models 1 ... 6
	...
	public void run(String arg) {
		...
		for (int levelNoise = 16; levelNoise<=256;  levelNoise += 16)  // level of noise vs. 256
